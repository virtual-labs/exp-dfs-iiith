...
function submit() {
  ...
  document.getElementById("ins").innerHTML =
    "Your sequence : " + dfs_exercise.selected;
  if (
    dfs_exercise.flagtocheck == 1 ||
    dfs_exercise.selected.length != dfs_exercise.correctseqlngth
  ) {
    document.getElementById("ins").innerHTML +=
      "<br>Incorrect!<br>Click <b>Reset</b> to try again";
  } else {
...
graph.on("click", function (params) {
  ...
  if (dfs_exercise.first == 0) {
    ...
    document.getElementById("ins").innerHTML =
      "Now perform DFS with source node <b>" + params["nodes"]["0"] + "</b>";
